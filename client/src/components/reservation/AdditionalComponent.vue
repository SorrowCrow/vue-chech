        ...
        <div class="wrap grid content-between">
            ...
            <div class="reservationForm__additional-item flex">
                ...
                <svg class="info" viewBox="0 0 46 46" fill="none" @click="info = !info">
                    <circle cx="23" cy="23" r="22" stroke="#C7B6DA" stroke-width="2" />
                    <path
                        v-if="!info"
